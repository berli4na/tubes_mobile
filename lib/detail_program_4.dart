...
class DetailProgram4 extends StatefulWidget {
  @override
  _DetailProgram4State createState() => _DetailProgram4State();
}

class _DetailProgram4State extends State<DetailProgram4> {
  Timer? _timer;
  ...
  final List<Map<String, dynamic>> _steps = [
    {
      'stepText':
          "Gunakan jari manis (karena tekanan lebih ringan) untuk memijat area mata.",
      'duration': 60
    },
    {
      'stepText':
          "Mulailah dari sudut dalam mata, lakukan gerakan melingkar kecil ke arah sudut luar mata.",
      'duration': 30
    },
    {
      'stepText':
          "Setelah mencapai sudut luar, lanjutkan gerakan ke arah tulang alis hingga kembali ke sudut dalam mata (membentuk lingkaran penuh).",
      'duration': 30
    },
    {'stepText': "Lakukan gerakan ini selama 1 menit.", 'duration': 60},
    {
      'stepText':
          "Gunakan ibu jari untuk menekan lembut area bawah alis (di atas tulang mata) selama 10 detik.",
      'duration': 10
    },
    {
      'stepText':
          "Akhiri dengan mengetuk-ngetuk area sekitar mata menggunakan ujung jari dengan gerakan cepat dan lembut selama 15-20 detik.",
      'duration': 20
    },
  ];
  ...
  void _startCountdown() {
    ...
    if (_currentStep < _steps.length) {
      setState(() {
        _countdownTime =
            _steps[_currentStep]['duration']; // Ambil durasi langkah saat ini
      });
...
class _PlayVideoTutorialState extends State<PlayVideoTutorial> {
  final videoURL = "https://www.youtube.com/watch?v=2wblPUqm7LY";
